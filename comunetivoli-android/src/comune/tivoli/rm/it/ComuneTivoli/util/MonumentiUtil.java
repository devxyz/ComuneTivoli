...
public class MonumentiUtil {
    ...
    public static List<MonumentiComune> elencoMonumenti(Activity a) {
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Casa_Gotica_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Cattedrale_di_San_Lorenzo_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Chiesa_della_Maria_SS_di_Quintiliolo_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Chiesa_di_San_Biagio_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Chiesa_di_San_Pietro_alla_Carità_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Chiesa_di_San_Silvestro_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Chiesa_di_Santa_Maria_Maggiore_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_Palazzo_della_Missione_Complesso_Mauro_Macera_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_acquedotti_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_anfiteatro_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_arcata_dell_acquedotto_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_mensa_ponderaria_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_piazza_campitelli_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_piazza_garibaldi_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_ponte_gregoriano_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_rocca_pia_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_santuario_ercole_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_tempio_della_sibilla_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_tempio_di_vesta_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_tomba_dei_plauzi_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_villa_adriana_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_villa_d_este_fotobig),
        ...
        monumenti.add(new MonumentiComune(
                ...
                (R.drawable.monumentixml_villa_gregoriana_fotobig),
