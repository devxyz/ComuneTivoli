...
public class LoginWebsites {
    ...
    private static final String LOGIN_USER_NAME = "stefano.millozzi@gmail.com";
    private static final String LOGIN_PASSWORD = "Stefano123";

    public static void main(String[] args) {
        LoginWebsites l=new LoginWebsites();
        final String s = l.httpPostLogin("https://www.facebook.com/");
     ...
     *
     * @throws IOException Any problems while doing the above.
     */
     ...
     * UTF-8 standard.
     *
     * @param loginUserName The user name for login
     * @param loginPassword The password for login
     * @return The complete login message that can be HTTP Posted
     * @throws UnsupportedEncodingException Any problems during URL encoding
     */
     ...
     *
     * @param targetUrl The URL to which the HTTP POST is made.
     * @param content   The contents which will be POSTed to the target URL.
     * @return The open URLConnection which can be used to read any response.
     * @throws IOException
     */
     ...
     *
     * @param urlConnection The URLConncetion from which the response will be read
     * @return The response read from the URLConnection
     * @throws IOException When problems encountered during reading the response from the
     *                     URLConnection.
     */
